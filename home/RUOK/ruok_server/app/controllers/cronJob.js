...
function sendSMS(patient, callback) {
  if (patient.length === 0) {
    ...
    client.messages.create({
       ...
       body: "Hello this is Dr. Duvoisin.  I hope you are feeling better today.  If you would like me to contact you in the next few hours please reply with 'Yes' or you can continue with your previous discharge instructions.   Thank you. " 
		//+ config.clientUrl + "/clientView/" + f.token
